 ...
 * @author pemi
 */
public final class LongDropWhileAction extends Action<LongStream, LongStream> {

    public LongDropWhileAction(LongPredicate predicate) {
        super(s -> Java9StreamUtil.dropWhile(s, requireNonNull(predicate)), LongStream.class, DROP_WHILE);
    }
