 ...
 * @author pemi
 */
public final class DoubleTakeWhileAction extends Action<DoubleStream, DoubleStream> {

    public DoubleTakeWhileAction(DoublePredicate predicate) {
        super(s -> Java9StreamUtil.takeWhile(s, requireNonNull(predicate)), DoubleStream.class, TAKE_WHILE);
    }
