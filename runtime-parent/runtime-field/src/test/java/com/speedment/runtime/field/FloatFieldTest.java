...
public final class FloatFieldTest {
    ...
    public void testInSet() {
        ...
        final Predicate<BasicEntity> t2 = field.in(Stream.of(0f, 1f).collect(Collectors.toSet()));
        final Predicate<BasicEntity> t3 = field.in(Stream.of(0f, 1f, 1f).collect(Collectors.toSet()));
        final Predicate<BasicEntity> t4 = field.in(Stream.of(-1f, 1f, 2f, 3f).collect(Collectors.toSet()));
        final Predicate<BasicEntity> t5 = field.in(Stream.of(-Float.MAX_VALUE, Float.MAX_VALUE).collect(Collectors.toSet()));
        final Predicate<BasicEntity> t6 = field.in(Stream.of(1f, 2f, 3f, 4f, 5f).collect(Collectors.toSet()));
        final Predicate<BasicEntity> t7 = field.in(Stream.of(100f, 101f, 102f, 103f, 104f).collect(Collectors.toSet()));
    ...
    public void testNotInSet() {
        ...
        final Predicate<BasicEntity> t2 = field.notIn(Stream.of(0f, 1f).collect(Collectors.toSet()));
        final Predicate<BasicEntity> t3 = field.notIn(Stream.of(0f, 1f, 1f).collect(Collectors.toSet()));
        final Predicate<BasicEntity> t4 = field.notIn(Stream.of(-1f, 1f, 2f, 3f).collect(Collectors.toSet()));
        final Predicate<BasicEntity> t5 = field.notIn(Stream.of(-Float.MAX_VALUE, Float.MAX_VALUE).collect(Collectors.toSet()));
        final Predicate<BasicEntity> t6 = field.notIn(Stream.of(1f, 2f, 3f, 4f, 5f).collect(Collectors.toSet()));
        final Predicate<BasicEntity> t7 = field.notIn(Stream.of(100f, 101f, 102f, 103f, 104f).collect(Collectors.toSet()));
