...
import static com.speedment.runtime.field.TestUtil.assertListEqual;
...
public class IntFieldTest {
    ...
    private BasicEntity a, b, c, d, e, f, g, h, i, j, k, l;
    ...
    public @Test void testBetween() {
        ...
        // Test the results
        assertListEqual("Test 0: between(0, 2):",                                a0, e0, FORMATTER);
        assertListEqual("Test 1: between(-2, 2):",                               a1, e1, FORMATTER);
        assertListEqual("Test 2: between(0, 2, START_EXCLUSIVE_END_EXCLUSIVE):", a2, e2, FORMATTER);
        assertListEqual("Test 3: between(0, 2, START_INCLUSIVE_END_EXCLUSIVE):", a3, e3, FORMATTER);
        assertListEqual("Test 4: between(0, 2, START_EXCLUSIVE_END_INCLUSIVE):", a4, e4, FORMATTER);
        assertListEqual("Test 5: between(0, 2, START_INCLUSIVE_END_INCLUSIVE):", a5, e5, FORMATTER);
    }
    
    public @Test void testEqual() {
        // Create a number of predicates
        ...
        final List<BasicEntity> e8 = emptyList();
        ...
        // Test the results
        assertListEqual("Test 0: equal(-1):",        a0, e0, FORMATTER);
        assertListEqual("Test 1: equal(0):",         a1, e1, FORMATTER);
        assertListEqual("Test 2: equal(1):",         a2, e2, FORMATTER);
        assertListEqual("Test 3: equal(2):",         a3, e3, FORMATTER);
        assertListEqual("Test 4: equal(3):",         a4, e4, FORMATTER);
        assertListEqual("Test 5: equal(-5):",        a5, e5, FORMATTER);
        assertListEqual("Test 6: equal(MIN_VALUE):", a6, e6, FORMATTER);
        assertListEqual("Test 7: equal(MAX_VALUE):", a7, e7, FORMATTER);
        assertListEqual("Test 8: equal(100):",       a8, e8, FORMATTER);
    }
    
    public @Test void testGreaterOrEqual() {
        // Create a number of predicates
        ...
        // Test the results
        assertListEqual("Test 0: greaterOrEqual(-1):",        a0, e0, FORMATTER);
        assertListEqual("Test 1: greaterOrEqual(0):",         a1, e1, FORMATTER);
        assertListEqual("Test 2: greaterOrEqual(1):",         a2, e2, FORMATTER);
        assertListEqual("Test 3: greaterOrEqual(2):",         a3, e3, FORMATTER);
        assertListEqual("Test 4: greaterOrEqual(3):",         a4, e4, FORMATTER);
        assertListEqual("Test 5: greaterOrEqual(-5):",        a5, e5, FORMATTER);
        assertListEqual("Test 6: greaterOrEqual(MIN_VALUE):", a6, e6, FORMATTER);
        assertListEqual("Test 7: greaterOrEqual(MAX_VALUE):", a7, e7, FORMATTER);
        assertListEqual("Test 8: greaterOrEqual(100):",       a8, e8, FORMATTER);
    }
    
    public @Test void testGreaterThan() {
        // Create a number of predicates
        ...
        final List<BasicEntity> e7 = emptyList();
        final List<BasicEntity> e8 = asList(k);
        ...
        // Test the results
        assertListEqual("Test 0: greaterThan(-1):",        a0, e0, FORMATTER);
        assertListEqual("Test 1: greaterThan(0):",         a1, e1, FORMATTER);
        assertListEqual("Test 2: greaterThan(1):",         a2, e2, FORMATTER);
        assertListEqual("Test 3: greaterThan(2):",         a3, e3, FORMATTER);
        assertListEqual("Test 4: greaterThan(3):",         a4, e4, FORMATTER);
        assertListEqual("Test 5: greaterThan(-5):",        a5, e5, FORMATTER);
        assertListEqual("Test 6: greaterThan(MIN_VALUE):", a6, e6, FORMATTER);
        assertListEqual("Test 7: greaterThan(MAX_VALUE):", a7, e7, FORMATTER);
        assertListEqual("Test 8: greaterThan(100):",       a8, e8, FORMATTER);
    }
    
    public @Test void testIn() {
        // Create a number of predicates
        ...
        // Create a number of expected results
        final List<BasicEntity> e0 = emptyList();
        final List<BasicEntity> e1 = asList(a, l);
        ...
        // Test the results
        assertListEqual("Test 0: in():",                        a0, e0, FORMATTER);
        assertListEqual("Test 1: in(0):",                       a1, e1, FORMATTER);
        assertListEqual("Test 2: in(0, 1):",                    a2, e2, FORMATTER);
        assertListEqual("Test 3: in(0, 1, 1):",                 a3, e3, FORMATTER);
        assertListEqual("Test 4: in(-1, 1, 2, 3):",             a4, e4, FORMATTER);
        assertListEqual("Test 5: in(MIN_VALUE, MAX_VALUE):",    a5, e5, FORMATTER);
        assertListEqual("Test 6: in(1, 2, 3, 4, 5):",           a6, e6, FORMATTER);
        assertListEqual("Test 7: in(100, 101, 102, 103, 104):", a7, e7, FORMATTER);
        assertListEqual("Test 8: in(-100):",                    a8, e8, FORMATTER);
    }
    
    public @Test void testInSet() {
        // Create a number of predicates
        final Predicate<BasicEntity> t0 = field.in(emptySet());
        final Predicate<BasicEntity> t1 = field.in(singleton(0));
        ...
        final Predicate<BasicEntity> t8 = field.in(singleton(-100));
        ...
        // Test the results
        assertListEqual("Test 0: inSet():",                        a0, e0, FORMATTER);
        assertListEqual("Test 1: inSet(0):",                       a1, e1, FORMATTER);
        assertListEqual("Test 2: inSet(0, 1):",                    a2, e2, FORMATTER);
        assertListEqual("Test 3: inSet(0, 1, 1):",                 a3, e3, FORMATTER);
        assertListEqual("Test 4: inSet(-1, 1, 2, 3):",             a4, e4, FORMATTER);
        assertListEqual("Test 5: inSet(MIN_VALUE, MAX_VALUE):",    a5, e5, FORMATTER);
        assertListEqual("Test 6: inSet(1, 2, 3, 4, 5):",           a6, e6, FORMATTER);
        assertListEqual("Test 7: inSet(100, 101, 102, 103, 104):", a7, e7, FORMATTER);
        assertListEqual("Test 8: inSet(-100):",                    a8, e8, FORMATTER);
    }
    
    public @Test void testLessThan() {
        // Create a number of predicates
        ...
        final List<BasicEntity> e6 = emptyList();
        ...
        // Test the results
        assertListEqual("Test 0: lessThan(-1):",        a0, e0, FORMATTER);
        assertListEqual("Test 1: lessThan(0):",         a1, e1, FORMATTER);
        assertListEqual("Test 2: lessThan(1):",         a2, e2, FORMATTER);
        assertListEqual("Test 3: lessThan(2):",         a3, e3, FORMATTER);
        assertListEqual("Test 4: lessThan(3):",         a4, e4, FORMATTER);
        assertListEqual("Test 5: lessThan(-5):",        a5, e5, FORMATTER);
        assertListEqual("Test 6: lessThan(MIN_VALUE):", a6, e6, FORMATTER);
        assertListEqual("Test 7: lessThan(MAX_VALUE):", a7, e7, FORMATTER);
        assertListEqual("Test 8: lessThan(100):",       a8, e8, FORMATTER);
    }
    
    public @Test void testLessOrEqual() {
        // Create a number of predicates
        ...
        // Test the results
        assertListEqual("Test 0: lessOrEqual(-1):",        a0, e0, FORMATTER);
        assertListEqual("Test 1: lessOrEqual(0):",         a1, e1, FORMATTER);
        assertListEqual("Test 2: lessOrEqual(1):",         a2, e2, FORMATTER);
        assertListEqual("Test 3: lessOrEqual(2):",         a3, e3, FORMATTER);
        assertListEqual("Test 4: lessOrEqual(3):",         a4, e4, FORMATTER);
        assertListEqual("Test 5: lessOrEqual(-5):",        a5, e5, FORMATTER);
        assertListEqual("Test 6: lessOrEqual(MIN_VALUE):", a6, e6, FORMATTER);
        assertListEqual("Test 7: lessOrEqual(MAX_VALUE):", a7, e7, FORMATTER);
        assertListEqual("Test 8: lessOrEqual(100):",       a8, e8, FORMATTER);
    }
    
    public @Test void testNotBetween() {
        // Create a number of predicates
        ...
        // Test the results
        assertListEqual("Test 0: notBetween(0, 2):",                                a0, e0, FORMATTER);
        assertListEqual("Test 1: notBetween(-2, 2):",                               a1, e1, FORMATTER);
        assertListEqual("Test 2: notBetween(0, 2, START_EXCLUSIVE_END_EXCLUSIVE):", a2, e2, FORMATTER);
        assertListEqual("Test 3: notBetween(0, 2, START_INCLUSIVE_END_EXCLUSIVE):", a3, e3, FORMATTER);
        assertListEqual("Test 4: notBetween(0, 2, START_EXCLUSIVE_END_INCLUSIVE):", a4, e4, FORMATTER);
        assertListEqual("Test 5: notBetween(0, 2, START_INCLUSIVE_END_INCLUSIVE):", a5, e5, FORMATTER);
    }
    
    public @Test void testNotEqual() {
        // Create a number of predicates
        ...
        // Test the results
        assertListEqual("Test 0: notEqual(-1):",        a0, e0, FORMATTER);
        assertListEqual("Test 1: notEqual(0):",         a1, e1, FORMATTER);
        assertListEqual("Test 2: notEqual(1):",         a2, e2, FORMATTER);
        assertListEqual("Test 3: notEqual(2):",         a3, e3, FORMATTER);
        assertListEqual("Test 4: notEqual(3):",         a4, e4, FORMATTER);
        assertListEqual("Test 5: notEqual(-5):",        a5, e5, FORMATTER);
        assertListEqual("Test 6: notEqual(MIN_VALUE):", a6, e6, FORMATTER);
        assertListEqual("Test 7: notEqual(MAX_VALUE):", a7, e7, FORMATTER);
        assertListEqual("Test 8: notEqual(100):",       a8, e8, FORMATTER);
    }
    
    public @Test void testNotIn() {
        // Create a number of predicates
        ...
        // Test the results
        assertListEqual("Test 0: notIn():",                        a0, e0, FORMATTER);
        assertListEqual("Test 1: notIn(0):",                       a1, e1, FORMATTER);
        assertListEqual("Test 2: notIn(0, 1):",                    a2, e2, FORMATTER);
        assertListEqual("Test 3: notIn(0, 1, 1):",                 a3, e3, FORMATTER);
        assertListEqual("Test 4: notIn(-1, 1, 2, 3):",             a4, e4, FORMATTER);
        assertListEqual("Test 5: notIn(MIN_VALUE, MAX_VALUE):",    a5, e5, FORMATTER);
        assertListEqual("Test 6: notIn(1, 2, 3, 4, 5):",           a6, e6, FORMATTER);
        assertListEqual("Test 7: notIn(100, 101, 102, 103, 104):", a7, e7, FORMATTER);
        assertListEqual("Test 8: notIn(-100):",                    a8, e8, FORMATTER);
    }
    
    public @Test void testNotInSet() {
        // Create a number of predicates
        final Predicate<BasicEntity> t0 = field.notIn(emptySet());
        final Predicate<BasicEntity> t1 = field.notIn(singleton(0));
        ...
        final Predicate<BasicEntity> t8 = field.notIn(singleton(-100));
