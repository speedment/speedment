 ...
 * @param <INT>  large integer expression type to use as result
 * @param <DEC>  large decimal expression type to use as result
 *
 * @author Emil Forslund
 * @since  3.1.0
 */
public interface HasPow<T, INT, DEC> {
