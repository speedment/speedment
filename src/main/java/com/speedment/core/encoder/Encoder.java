...
public interface Encoder<ENTITY, R extends Encoder<ENTITY, R, OUTPUT_TYPE>, OUTPUT_TYPE> {
     ...
     * @return a reference to a resulting JsonFormatter
     */
    <T extends Comparable<? super T>, FK_ENTITY> R put(ComparableReferenceForeignKeyField<ENTITY, T, FK_ENTITY> field, Encoder<FK_ENTITY, ?, OUTPUT_TYPE> fkFormatter);
     ...
     * @return a reference to a resulting JsonFormatter
     */
    <FK_ENTITY> R put(StringReferenceForeignKeyField<ENTITY, FK_ENTITY> field, Encoder<FK_ENTITY, ?, OUTPUT_TYPE> fkFormatter);
