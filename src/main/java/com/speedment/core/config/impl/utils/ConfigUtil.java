 ...
 * the License.
 */
package com.speedment.core.config.impl.utils;
...
public final class ConfigUtil {
     ...
     * @param createAndAdder  the method to use for creating and adding new
     *                        node instances
     * @return                the produced instace
     */
    ...
    /**
     * Creates a supplier that can be called to create {@link SpeedmentException}
     * that explains that there is no nodes of one type for the other type by
     * the specified name.
     * 
     ...
     */
    private ConfigUtil() { instanceNotAllowed(getClass()); }
}