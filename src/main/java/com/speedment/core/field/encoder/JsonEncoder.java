 ...
 * the License.
 */
package com.speedment.core.field.encoder;

import com.speedment.api.field.Encoder;
...
public class JsonEncoder<ENTITY> implements Encoder<ENTITY, JsonEncoder<ENTITY>, String> {
     ...
     * @param <ENTITY>  the Entity type
     * @param manager   of the entity
     * @return          a new JsonFormatter with all the Entity fields added to 
     *                  the renderer
     */
     ...
     * @return          a new JsonFormatter with the specified fields added to 
     *                  the renderer
     */
    @SafeVarargs
