...
import static com.speedment.core.stream.builder.action.StandardBasicAction.BOXED;
 ...
 * @author pemi
 */
public class DoubleBoxedAction extends Action<DoubleStream, Stream<Double>> {
