...
import com.speedment.core.stream.builder.action.reference.DistinctAction;
import com.speedment.core.stream.builder.action.reference.FilterAction;
import com.speedment.core.stream.builder.action.reference.FlatMapAction;
import com.speedment.core.stream.builder.action.reference.FlatMapToDoubleAction;
import com.speedment.core.stream.builder.action.reference.FlatMapToIntAction;
import com.speedment.core.stream.builder.action.reference.FlatMapToLongAction;
import com.speedment.core.stream.builder.action.reference.LimitAction;
import com.speedment.core.stream.builder.action.reference.MapAction;
import com.speedment.core.stream.builder.action.reference.MapToDoubleAction;
import com.speedment.core.stream.builder.action.reference.MapToIntAction;
import com.speedment.core.stream.builder.action.reference.MapToLongAction;
import com.speedment.core.stream.builder.action.reference.PeekAction;
import com.speedment.core.stream.builder.action.reference.SkipAction;
import com.speedment.core.stream.builder.action.reference.SortedAction;
