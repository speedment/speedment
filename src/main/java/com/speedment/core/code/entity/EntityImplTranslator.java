...
import com.speedment.core.code.AbstractBaseEntity;
 ...
 * @author pemi
 */
public class EntityImplTranslator extends EntityAndManagerTranslator<Class> {
    
    private static final String SPEEDMENT_NAME = "speedment";
