...
public final class PostgresDbmsType extends AbstractDbmsType {
    ...
    public SpeedmentPredicateView getSpeedmentPredicateView() {
  	...
  	private static final Set<SqlTypeInfo> DATA_TYPES = Stream.of(
      	...
      	new SqlTypeInfo("user_mappings",2002,0,0,(short)1,true)).collect(collectingAndThen(toSet(), Collections::unmodifiableSet));
