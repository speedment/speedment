...
public final class SqliteDbmsType {
    ...
    private static Set<SqlTypeInfo> dataTypes() {
        ...
        return Stream.of(
                ...
                new SqlTypeInfo("SMALLINT", Types.INTEGER, 0, 0, (short) 1, false),
                new SqlTypeInfo("MEDIUMINT", Types.INTEGER, 0, 0, (short) 1, false),
                new SqlTypeInfo("BIGINT", Types.INTEGER, 0, 0, (short) 1, false),
                new SqlTypeInfo("UNSIGNED BIG INT", Types.INTEGER, 0, 0, (short) 1, false),
                new SqlTypeInfo("INT2", Types.INTEGER, 0, 0, (short) 1, false),
                new SqlTypeInfo("INT8", Types.INTEGER, 0, 0, (short) 1, false),
                new SqlTypeInfo("TINYINT", Types.INTEGER, 0, 0, (short) 1, false),
                new SqlTypeInfo("FLOAT", Types.REAL, 1000, 1000, (short) 1, false),
                new SqlTypeInfo("REAL", Types.REAL, 1000, 1000, (short) 1, false),
                new SqlTypeInfo("DOUBLE", Types.REAL, 1000, 1000, (short) 1, false),
                new SqlTypeInfo("DOUBLE PRECISION", Types.REAL, 1000, 1000, (short) 1, false),
                new SqlTypeInfo("NUMERIC", Types.NUMERIC, 1000, 1000, (short) 1, false),
                new SqlTypeInfo("DECIMAL", Types.NUMERIC, 1000, 1000, (short) 1, false),
                new SqlTypeInfo("BOOLEAN", Types.NUMERIC, 1000, 1000, (short) 1, false),
                new SqlTypeInfo("DATE", Types.NUMERIC, 1000, 1000, (short) 1, false),
                new SqlTypeInfo("DATETIME", Types.NUMERIC, 1000, 1000, (short) 1, false),
                new SqlTypeInfo("TEXT", Types.VARCHAR, 0, 0, (short) 1, true),
                new SqlTypeInfo("CLOB", Types.VARCHAR, 0, 0, (short) 1, true),
                new SqlTypeInfo("CHARACTER", Types.VARCHAR, 0, 0, (short) 1, true),
