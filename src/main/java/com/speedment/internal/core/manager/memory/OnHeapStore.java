 ...
 * subset of all entities that have a value 'id' greater than 100 or the subset
 * of all entities with the value 'date' lesser than '2015-01-01'.
 * <p>
...
public class OnHeapStore<ENTITY> {
    ...
    private final Map<ReferenceComparableField<ENTITY, ? extends Comparable<?>>, SortedMap<? extends Comparable<?>, Set<ENTITY>>> stores;
    ...
    public <V extends Comparable<V>> Stream<ENTITY> where(
        ComparablePredicateBuilder<ENTITY, V> predicate) {

        final ReferenceComparableField<ENTITY, V> field = predicate.getField();
        final V value = predicate.getOperand();
