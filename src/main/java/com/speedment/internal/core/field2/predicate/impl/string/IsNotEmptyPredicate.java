...
import static com.speedment.internal.core.field2.predicate.PredicateType.IS_NOT_EMPTY;
...
public class IsNotEmptyPredicate<ENTITY> extends SpeedmentPredicateImpl<ENTITY, String>
    ...
    public IsNotEmptyPredicate(Getter<ENTITY, String> getter) {
        super(IS_NOT_EMPTY, getter);
    }
