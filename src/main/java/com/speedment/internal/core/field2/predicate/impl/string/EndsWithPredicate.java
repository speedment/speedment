...
import static com.speedment.field2.predicate.PredicateType.ENDS_WITH;
...
public class EndsWithPredicate<ENTITY> extends BaseStringPredicate<ENTITY>
    ...
    public EndsWithPredicate(FieldTrait field, Getter<ENTITY, String> getter, String operand0) {
        super(ENDS_WITH, field, getter, operand0, ENDS_WITH_PREDICATE);
    }
