...
import static com.speedment.internal.core.field2.predicate.PredicateType.ENDS_WITH;
...
public class EndsWithPredicate<ENTITY> extends BaseStringPredicate<ENTITY>
    ...
    public EndsWithPredicate(Getter<ENTITY, String> getter, String operand0) {
        super(ENDS_WITH, getter, operand0, ENDS_WITH_PREDICATE);
    }
