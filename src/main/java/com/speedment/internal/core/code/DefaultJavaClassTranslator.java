 ...
 * @param <J>   Java type (Interface, Class or Enum) to generate
 */
public abstract class DefaultJavaClassTranslator<DOC extends Document & HasName & HasEnabled & HasMainInterface, J extends ClassOrInterface<J>>
        implements JavaClassTranslator<DOC> {
    ...
    public DefaultJavaClassTranslator(Speedment speedment, Generator codeGenerator, DOC configEntity) {
        ...
        this.document = requireNonNull(configEntity);
