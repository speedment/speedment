...
//            sb.append("));");
    ...
    public static String typeMapperName(JavaLanguageNamer namer, Column col) {
        return namer.javaTypeName(col.getParentOrThrow().getJavaName()) + "." + namer.javaStaticFieldName(col.getJavaName()) + ".typeMapper()";
    }
