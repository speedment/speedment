 ...
 */
public class FlatMapAction<T, R> implements Action<T, R> {

    private final Function<? super T, ? extends Stream<? extends R>> mapper;

    public FlatMapAction(final Function<? super T, ? extends Stream<? extends R>> mapper) {
        this.mapper = mapper;
    }

    public Function<? super T, ? extends Stream<? extends R>> getMapper() {
        return mapper;
    }
