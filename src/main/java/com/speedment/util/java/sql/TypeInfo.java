...
public class TypeInfo {
    ...
    public TypeInfo(String sqlTypeName, int javaSqlTypeInt, int precision, int decimals, short nullable, boolean unsigned) {
    ...
    public static TypeInfo from(ResultSet rs) throws SQLException {
        ...
        return new TypeInfo(sqlTypeName, javaSqlTypeInt, precision, precision, nullable, unsigned);
    }
