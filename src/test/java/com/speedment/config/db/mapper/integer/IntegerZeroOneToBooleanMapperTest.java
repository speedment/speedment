 ...
 * the License.
 */
package com.speedment.config.db.mapper.integer;
...
public class IntegerZeroOneToBooleanMapperTest {
    ...
    public void testStringYesMapping() {
        Assert.assertEquals("JavaType should have value 'true'",  true, mapper.toJavaType(new Integer(1)));
        
        Assert.assertEquals("JavaType should have value 'true'",  true, mapper.toJavaType(new Integer(2)));
    ...
    public void testStringNoMapping() {
    	Assert.assertEquals("JavaType should have value 'false'",  false, mapper.toJavaType(new Integer(0)));
