...
* **Speedment HyperStream** - An extension av Speedment Stream which also includes hypersonic query performance enabled by a unique and in-JVM-memory management model. Learn more at [speedment.com/hyperStream](http://speedment.com/hyperstream).
