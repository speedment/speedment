 ...
 */
public final class H2DbmsType extends AbstractDbmsType {

    public static InjectBundle include() {
        return of(H2DbmsMetadataHandler.class, H2DbmsOperationHandler.class);
    }
    ...
    private @Inject
    H2DbmsMetadataHandler metadataHandler;
    private @Inject
    H2DbmsOperationHandler operationHandler;
