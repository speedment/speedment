...
import com.speedment.common.function.ObjFloatConsumer;
...
/**
 * Primitive collector that operates on {@code float} values, resulting in a
 * single {@code double}.
 * 
 ...
 * @see Collector
 */
public interface FloatToDoubleCollector<A> {
     ...
     * #supplier()} and adds a single {@code float} value to it.
     * 
     * @return the accumulator
     * 
     * @see Collector#accumulator()
     */
    ObjFloatConsumer<A> accumulator();
