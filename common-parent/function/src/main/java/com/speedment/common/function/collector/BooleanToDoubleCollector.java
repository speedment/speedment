...
/**
 * Primitive collector that operates on {@code boolean} values, resulting in a
 * single {@code double}.
 * 
 ...
 * @see Collector
 */
public interface BooleanToDoubleCollector<A> {
     ...
     * #supplier()} and adds a single {@code boolean} value to it.
     * 
     * @return the accumulator
     * 
     * @see Collector#accumulator()
     */
    ObjBooleanConsumer<A> accumulator();
