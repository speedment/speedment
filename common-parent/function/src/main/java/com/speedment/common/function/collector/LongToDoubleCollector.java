...
import com.speedment.common.function.ObjLongConsumer;
...
/**
 * Primitive collector that operates on {@code long} values, resulting in a
 * single {@code double}.
 * 
 ...
 * @see Collector
 */
public interface LongToDoubleCollector<A> {
