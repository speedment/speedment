...
/**
 * Primitive collector that operates on {@code short} values, resulting in a
 * single {@code long}.
 * 
 ...
 * @see Collector
 */
public interface ShortToLongCollector<A> {
     ...
     * #supplier()} and adds a single {@code short} value to it.
     * 
