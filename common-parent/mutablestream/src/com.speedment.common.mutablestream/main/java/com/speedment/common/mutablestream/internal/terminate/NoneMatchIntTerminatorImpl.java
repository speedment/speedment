 ...
 * @since   1.0.0
 */
public final class NoneMatchIntTerminatorImpl
extends AbstractTerminator<Integer, IntStream, Boolean> 
implements NoneMatchIntTerminator {

    private final IntPredicate predicate;

    public NoneMatchIntTerminatorImpl(HasNext<Integer, IntStream> previous, boolean parallel, IntPredicate predicate) {
