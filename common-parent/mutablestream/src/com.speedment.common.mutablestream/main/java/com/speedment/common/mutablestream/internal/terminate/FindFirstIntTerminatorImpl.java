 ...
 * @since   1.0.0
 */
public final class FindFirstIntTerminatorImpl
extends AbstractTerminator<Integer, IntStream, OptionalInt> 
implements FindFirstIntTerminator {

    public FindFirstIntTerminatorImpl(HasNext<Integer, IntStream> previous, boolean parallel) {
