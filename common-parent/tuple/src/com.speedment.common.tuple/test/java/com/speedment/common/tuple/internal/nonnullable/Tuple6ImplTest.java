...
public final class Tuple6ImplTest<T0, T1, T2, T3, T4, T5> extends AbstractTupleImplTest<Tuple6Impl<Integer, Integer, Integer, Integer, Integer, Integer>> {
    
    public Tuple6ImplTest() {
