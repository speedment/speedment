...
public final class Tuple8ImplTest<T0, T1, T2, T3, T4, T5, T6, T7> extends AbstractTupleImplTest<Tuple8Impl<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Integer>> {
    
    public Tuple8ImplTest() {
