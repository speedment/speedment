...
public final class Tuple5ImplTest<T0, T1, T2, T3, T4> extends AbstractTupleImplTest<Tuple5Impl<Integer, Integer, Integer, Integer, Integer>> {
    
    public Tuple5ImplTest() {
