 ...
 * @author Per Minborg
 */
public final class Tuple10OfNullablesMapperImpl<T, T0, T1, T2, T3, T4, T5, T6, T7, T8, T9> implements TupleMapper<T, Tuple10OfNullables<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
