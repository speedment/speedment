...
/**
 * A conviniency class for mapping between column types using a database specific ruleset.
 * 
...
public interface JavaTypeMap {
    ...
    Class<?> findJdbcType(Map<String, Class<?>> sqlTypeMapping, ColumnMetaData md);
