...
@Api(version = "3.0")
@FunctionalInterface
public interface BooleanSetter<ENTITY> extends Setter<ENTITY, Boolean> {
    ...
    @Override
    default ENTITY apply(ENTITY instance, Boolean value) {
        return setAsBoolean(instance, value);
    }
}