 ...
 * @since   3.0.0
 */
public final class LongGreaterOrEqualPredicate<ENTITY, D>
        extends AbstractFieldPredicate<ENTITY, LongFieldTrait<ENTITY, D>>
        implements Tuple1<Long> {

    private final long value;
    
    public LongGreaterOrEqualPredicate(LongFieldTrait<ENTITY, D> field, long value) {
        super(GREATER_OR_EQUAL, field, entity -> field.getAsLong(entity) >= value);
        this.value = value;
    }
