 ...
 * @author  Per Minborg
 */
public class ComparableReferenceForeignKeyFieldImpl<ENTITY, D, V extends Comparable<? super V>, FK> implements ComparableForeignKeyField<ENTITY, D, V, FK> {
    ...
    public ComparableReferenceForeignKeyFieldImpl(
        ...
        field                    = new FieldTraitImpl(identifier, getter, setter, unique);
        referenceField           = new ReferenceFieldImpl<>(field, typeMapper);
