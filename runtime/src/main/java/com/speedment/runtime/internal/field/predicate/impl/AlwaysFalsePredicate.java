 ...
 * the License.
 */
package com.speedment.runtime.internal.field.predicate.impl;
 ...
 * @since   2.2.0
 */
public final class AlwaysFalsePredicate<ENTITY, FIELD extends FieldTrait<ENTITY>> 
        extends AbstractFieldPredicate<ENTITY, FIELD> {

    public AlwaysFalsePredicate(FIELD field) {
        super(ALWAYS_FALSE, field, entity -> false);
    }
}
