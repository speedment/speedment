...
public final class ReferenceIsNullPredicate<ENTITY, D, V>
        extends AbstractFieldPredicate<ENTITY, ReferenceFieldTrait<ENTITY, D, V>> {
    
    public ReferenceIsNullPredicate(ReferenceFieldTrait<ENTITY, D, V> field) {
        super(IS_NULL, field, entity -> entity == null);
    }
}