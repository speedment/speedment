...
public interface CodeGenerationComponent {
    ...
    findTranslator(DOC document, TranslatorKey<DOC, T> key) throws SpeedmentGeneratorException {
    ...
    findTranslator(DOC document, Class<T> modelType, String key) throws SpeedmentGeneratorException;
